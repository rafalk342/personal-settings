...
+SC10::SendKey("U+0051", {}) ; Q
 ...
 SC11::SendKey("U+0077", {"**": "U+0144"}) ; w
+SC11::SendKey("U+0057", {"**": "U+0143"}) ; W

 SC12::SendKey("U+0065", {"**": "U+0119"}) ; e
+SC12::SendKey("U+0045", {"**": "U+0118"}) ; E
...
;  Letters, second row
 ...
 SC1e::SendKey("U+0061", {"**": "U+0105"}) ; a
+SC1e::SendKey("U+0041", {"**": "U+0104"}) ; A

 SC1f::SendKey("U+0073", {"**": "U+015b"}) ; s
+SC1f::SendKey("U+0053", {"**": "U+015a"}) ; S

 SC20::SendKey("U+0064", {"**": "U+00f3"}) ; d
+SC20::SendKey("U+0044", {"**": "U+00d3"}) ; D

 SC21::SendKey("U+0066", {"**": "U+0142"}) ; f
+SC21::SendKey("U+0046", {"**": "U+0141"}) ; F
...
;  Letters, third row
 ...
 SC2c::SendKey("U+007a", {"**": "U+017c"}) ; z
+SC2c::SendKey("U+005a", {"**": "U+017b"}) ; Z

 SC2d::SendKey("U+0078", {"**": "U+017a"}) ; x
+SC2d::SendKey("U+0058", {"**": "U+0179"}) ; X

 SC2e::SendKey("U+0063", {"**": "U+0107"}) ; c
+SC2e::SendKey("U+0043", {"**": "U+0106"}) ; C
...
;  Letters, first row
 ...
 <^>!SC16::SendKey("U+0037", {}) ; 7

 <^>!SC17::SendKey("U+0038", {}) ; 8

 <^>!SC18::SendKey("U+0039", {}) ; 9
...
<^>!+SC1f::SendKey("U+00a6", {}) ; ¦
 ...
 <^>!SC24::SendKey("U+0034", {}) ; 4

 <^>!SC25::SendKey("U+0035", {}) ; 5

 <^>!SC26::SendKey("U+0036", {}) ; 6
...
;  Letters, third row
 ...
 <^>!SC31::SendKey("U+0030", {}) ; 0

 <^>!SC32::SendKey("U+0031", {}) ; 1

 <^>!SC33::SendKey("U+0032", {}) ; 2

 <^>!SC34::SendKey("U+0033", {}) ; 3
